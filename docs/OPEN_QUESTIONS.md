...
- Numero definitivo di preferenze per pool: il testo storico alterna 5 e 6.
- Tie-breaker delle offerte uguali.
- Minimo d’offerta corrente e gestione offerte non valide.
- Regola corrente quando nessuna preferenza vince.
- Regole precise di completamento/amministrazione nei giri aperti.
- Formato effettivo dei file admin da importare.
