...
- Prossimo: Stage 3 (ingest manuale Understat → feature xG/xA → propensione gol/assist nel MC). In alternativa, rivedere il target conceded-pmf per i portieri (causa del fallimento del gate Stage 2).
